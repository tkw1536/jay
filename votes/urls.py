...
from votes.views import VoteView, results, system_home, system_settings, admin_add, admin_remove, vote_edit, vote_filter, vote_options_add, vote_options_edit, vote_options_remove
